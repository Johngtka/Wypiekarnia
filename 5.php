...
<body>
  ...
  <div class="main">
    ...
    if (isset($_POST['czek'])) {
      echo "<b>Ciastka z czekoladą</b><br>";
      $opt = array('nazwa' => 'Ciastka z czekoladą');
      $op = $opt['nazwa'];
    }
    if (isset($_POST['ziarna'])) {
      echo "<b>Ciastka Ziarna w Karmelu</b><br>";
      $opt = array('nazwa' => 'Ciastka ziarna w karmelu');
      $op = $opt['nazwa'];
    }
    if (isset($_POST['ziarna'])) {
      echo "<b>Ciastka Owsiane z bakaliami</b><br>";
      $opt = array('nazwa' => 'Ciastka owsiane z bakaliami');
      $op = $opt['nazwa'];
    }
    if (isset($_POST['cantuccini'])) {
      echo "<b>Ciastka Cantuccini</b><br>";
      $opt = array('nazwa' => 'Ciastka z cantuccini');
      $op = $opt['nazwa'];
    }
