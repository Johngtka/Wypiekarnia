...
<html lang="pl-PL">
    ...
    <div class="main">
        <?php
          ...
          if (isset($_POST['jablkowe'])) echo "Jabłkowych na mlecznym kremie<br>"; 
          if (isset($_POST['wiosenne'])) echo "Wiosennych<br>";
          if (isset($_POST['czekorz']))echo "Czekoladowo-Orzechowych<br>";
          if (isset($_POST['malinowe'])) echo "Malinowych<br>";
