...
<html lang="pl-PL">
    ...
    <div class="main">
        <?php
          ...
          if (isset($_POST['drozdzowe'])) echo "Drożdżowych<br>"; 
          if (isset($_POST['sernik'])) echo "Serników<br>";
          if (isset($_POST['brown']))echo "Brown'e<br>";
          if (isset($_POST['dziec'])) echo "Dziecięcych<br>";
